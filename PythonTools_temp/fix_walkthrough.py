...
# Find cell #VSC-4d390510 (the broken walkthrough cell)
for i, cell in enumerate(nb['cells']):
    if cell.get('id') == '#VSC-4d390510':
...
"""
        ...
        nb['cells'][i]['source'] = full_content.split('\n')
        
        # Save
        with open(nb_path, 'w', encoding='utf-8') as f:
            json.dump(nb, f, indent=1, ensure_ascii=False)
        
        print("✅ Walkthrough restaurado com todas as seções (1-5)!")
        break
else:
